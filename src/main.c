...
int main(int argc, char *argv[]) {
    ...
    nome_base_qry = arquivo_extrair_nome_base(caminho_qry, ".qry");
    ...
    cidade = processa_geo(arqGeo, caminho_output, nome_base_qry);
    if (cidade == NULL) {
    ...
    if (caminho_pm != NULL) {
        ...
        cadastro = processa_pm(arqPm, cidade, caminho_output, nome_base_qry);
        if (cadastro == NULL) {
